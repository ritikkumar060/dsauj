    ...
    if results.multi_hand_landmarks:
        for hand_landmarks in results.multi_hand_landmarks:
            ...
            if dist_thumb_index > 100 and dist_index_pinky > 100:  
                ...
                time.sleep(1)  # Add delay to prevent rapid zooming
            ...
            # Ensure a 1-second delay before repeating the action
            if time.time() - last_action_time > 1:  
                ...
                elif abs(index_x - pinky_x) < 70 and abs(index_y - pinky_y) > 130:
            ...
            if time.time() - last_action_time > 1:
                ...
                time.sleep(1)  # Add delay to prevent multiple triggers
